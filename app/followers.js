...
var cache = { followers: [], ids: [], prev: 0, next: 0, index: 0 };
var Followers = /** @class */ (function (_super) {
    ...
    Followers.prototype.followers = function (id, obj) {
        ...
        this.fetch("https://api.twitter.com/1.1/followers/ids.json?" + options, 'GET')
            ...
            var index = cache.index, result;
            while (index < cache.ids.length) {
                result = _this.lookup(cache.ids.slice(index, index + 100));
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.fetch("https://api.twitter.com/1.1/users/lookup.json?" + ids, 'POST')];
                    case 1:
                        val = _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
